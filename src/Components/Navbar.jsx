  ...
  return (
    <nav className="fixed top-0 z-10 flex w-full items-center justify-between border-b border-b-gray-700 bg-black/70 px-16 py-6 text-white backdrop-blur-md md:justify-evenly">
      ...
      <ul className="hidden md:flex gap-5">
        <li className="cursor-pointer text-2xl opacity-70 transition-all duration-100 hover:text-orange-500 hover:opacity-100">
          <BsGithub />
        </li>
        ...
        <li className="cursor-pointer text-2xl opacity-70 transition-all duration-300 hover:text-sky-600 hover:opacity-100">
          <BsFacebook />
        </li>
      </ul>
      ...
      {isOpen && (<div className={`fixed right-0 top-[84px] flex h-screen w-1/2 flex-col items-start justify-start gap-10 border-1 border-gray-800 bg-black/90 p-12 ${isOpen ? "block" : "hidden"}`}>
